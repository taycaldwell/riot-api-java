...
final class MatchListApi {
    ...
    public static MatchList getMatchList(String endpoint, String region, String key, long summonerId, String championIds, String rankedQueues, String seasons, long beginTime, long endTime, int beginIndex, int endIndex) throws RiotApiException {
